...
const homeTextsEn: HomeTexts = {
    ...
    responsiveExplain: "With responsive  design I can make apps that look beautiful on any device.",
    renderingStrategies: "Rendering Strategies",
    csr: "Components or pages that determined on the client.",
    ssr: "Components or pages that are determined on request time.",
    ssg: "Prerendered pages.",
    isr: "Prerendered pages that are updated on some interval or event.",
